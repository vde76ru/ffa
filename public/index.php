...
$productController = new ProductController(); // ✅ Создаем ДО использования
...
$router->get('/api/product/{id}/info', [$productController, 'ajaxProductInfoAction']); // ✅ Теперь работает
